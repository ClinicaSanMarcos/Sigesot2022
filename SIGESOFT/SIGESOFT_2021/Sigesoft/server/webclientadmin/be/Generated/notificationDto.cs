...
namespace Sigesoft.Server.WebClientAdmin.BE
{
    ...
    public partial class notificationDto
    {
        ...
        public notificationDto(String v_NotificationId, String v_OrganizationId, Nullable<DateTime> d_NotificationDate, String v_PersonId, String v_Title, String v_Body, Nullable<Int32> i_IsRead, Nullable<Int32> i_TypeNotificationId, Nullable<DateTime> d_ScheduleDate, Nullable<Int32> i_StateNotificationId, String v_Path, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate)
        {
