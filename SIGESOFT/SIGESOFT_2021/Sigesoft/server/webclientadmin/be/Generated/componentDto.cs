...
namespace Sigesoft.Server.WebClientAdmin.BE
{
    ...
    public partial class componentDto
    {
        ...
        [DataMember()]
        public Nullable<Int32> i_SubGroupId { get; set; }

        [DataMember()]
        public String v_ComentaryUpdate { get; set; }

        [DataMember()]
        public Nullable<Int32> i_KindOfService { get; set; }

        [DataMember()]
        public Nullable<Int32> i_PriceIsRecharged { get; set; }
        ...
        public componentDto(String v_ComponentId, String v_Name, Nullable<Int32> i_CategoryId, Nullable<Single> r_BasePrice, Nullable<Int32> i_DiagnosableId, Nullable<Int32> i_IsApprovedId, Nullable<Int32> i_ComponentTypeId, Nullable<Int32> i_UIIsVisibleId, Nullable<Int32> i_UIIndex, Nullable<Int32> i_ValidInDays, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, String v_IdUnidadProductiva, Nullable<Single> r_PriceSegus, String v_CodigoSegus, Nullable<Int32> i_GroupId, Nullable<Int32> i_SubGroupId, String v_ComentaryUpdate, Nullable<Int32> i_KindOfService, Nullable<Int32> i_PriceIsRecharged, List<attentioninareacomponentDto> attentioninareacomponent, List<auxiliaryexamDto> auxiliaryexam, List<componentfieldsDto> componentfields, List<protocolcomponentDto> protocolcomponent, List<recommendationDto> recommendation, List<restrictionDto> restriction, List<rolenodecomponentprofileDto> rolenodecomponentprofile, List<servicecomponentDto> servicecomponent)
        {
			...
			this.r_PriceSegus = r_PriceSegus;
			this.v_CodigoSegus = v_CodigoSegus;
			this.i_GroupId = i_GroupId;
			this.i_SubGroupId = i_SubGroupId;
			this.v_ComentaryUpdate = v_ComentaryUpdate;
			this.i_KindOfService = i_KindOfService;
			this.i_PriceIsRecharged = i_PriceIsRecharged;
