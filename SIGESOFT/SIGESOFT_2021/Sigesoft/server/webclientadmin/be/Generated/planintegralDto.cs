...
namespace Sigesoft.Server.WebClientAdmin.BE
{
    ...
    public partial class planintegralDto
    {
        ...
        public planintegralDto(String v_PlanIntegral, String v_PersonId, Nullable<Int32> i_TipoId, String v_Descripcion, Nullable<DateTime> d_Fecha, String v_Lugar, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, String v_ComentaryUpdate)
        {
