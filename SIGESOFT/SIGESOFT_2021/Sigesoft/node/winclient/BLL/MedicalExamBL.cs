      ...
      public List<MedicalExamList> GetMedicalExamPagedAndFiltered(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression)
      {
          ...
          try
          {
              ...
              var query = from A in dbContext.component
                          ...
                          join D in dbContext.systemparameter on new { a = B.i_ParentParameterId.Value, b = 116 }  // CATEGORIA DEL EXAMEN
                                                          equals new { a = D.i_ParameterId, b = D.i_GroupId } into D_join
                          from D in D_join.DefaultIfEmpty()

                          join C in dbContext.systemparameter on new { a = A.i_UIIndex.Value, b = 116 }  // SUB CATEGORIA DEL EXAMEN
