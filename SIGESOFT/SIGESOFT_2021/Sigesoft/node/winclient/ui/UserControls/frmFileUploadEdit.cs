        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            switch (_action)
            {
                case ActionForm.Add:
                    ...
                    var servicecomponent = new ServiceBL().GetServiceComponent(ServiceComponentId);
                    var service = new ServiceBL().GetService(ref operationResult, servicecomponent.v_ServiceId);
                    ProtocolId = service.v_ProtocolId;
