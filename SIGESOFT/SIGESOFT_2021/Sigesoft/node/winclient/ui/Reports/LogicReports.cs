...
namespace Sigesoft.Node.WinClient.UI.Reports
{
    public class LogicReports
    {
        ...
        private string ChooseReport(string componentId, string serviceId, string pPacienteId, int pintIdCrystal)
        {
            ...
            switch (componentId)
            {
                ...
                //    var componentReportId1 = _serviceBL.ObtenerIdsParaImportacionExcel(servicesId1, 11);

                //    var AscensoAlturas = _serviceBL.ReportAscensoGrandesAlturas(_serviceId, componentId, componentReportId1[0].ComponentId);
                //    var FuncionesVitales = _serviceBL.ReportFuncionesVitales(_serviceId, Constants.FUNCIONES_VITALES_ID);
                //    var Antropometria = _serviceBL.ReportAntropometria(_serviceId, Constants.ANTROPOMETRIA_ID);
                ...
                case Constants.APENDICE_ID:
                    ...
                    if (pintIdCrystal == 43)
                    {
                        ...
                        rp.ExportOptions.ExportDestinationType = ExportDestinationType.DiskFile;
                        objDiskOpt = new DiskFileDestinationOptions();
                        objDiskOpt.DiskFileName = _ruta + serviceId + "-" + Constants.APENDICE_ID + ".pdf";
                        _filesNameToMerge.Add(objDiskOpt.DiskFileName);
                        rp.ExportOptions.DestinationOptions = objDiskOpt;
                        rp.Export();
                        rp.Close();
                ...
                case Constants.AUDIOMETRIA_ID:
                    ...
                    //var dataListForReport_1 = _serviceBL.ReportHistoriaOcupacionalAudiometria(_serviceId);
                ...
                case Constants.INFORME_ESPIROMETRIA:
                    ...
                    if (pintIdCrystal == 46)
                    {
                        ...
                        rp.ExportOptions.ExportDestinationType = ExportDestinationType.DiskFile;
                        objDiskOpt = new DiskFileDestinationOptions();
                        objDiskOpt.DiskFileName = _ruta + serviceId + "-" + Constants.INFORME_ESPIROMETRIA + ".pdf";
                        _filesNameToMerge.Add(objDiskOpt.DiskFileName);
                        rp.ExportOptions.DestinationOptions = objDiskOpt;
                ...
                case Constants.TEST_VERTIGO_ID:
                    ...
                    //var TEST_VERTIGO_ID = _serviceBL.GetReportTestVertigo(_serviceId, Constants.TEST_VERTIGO_ID, componentReportId[0].ComponentId);
                ...
                case Constants.LUMBOSACRA_ID:
                    ...
                    if (categoryId == 6)
                    {
                        ...
                        LUMBOSACRA_ID = _serviceBL.ReporteLumboSaca(_serviceId, Componente);
                ...
                //    var OJO_SECO_ID = _serviceBL.ReporteOjoSeco(_serviceId, Constants.OJO_SECO_ID);
