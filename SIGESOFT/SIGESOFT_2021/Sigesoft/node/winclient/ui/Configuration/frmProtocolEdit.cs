...
namespace Sigesoft.Node.WinClient.UI.Configuration
{
    public partial class frmProtocolEdit : Form
    {
        ...
        string[] nombreCampos =
        {
            ...
            "txtNombreProtocolo", "cbTipoExamen", "txtFactor", "txtEps", "txtCamaHosp", "txtDiscount", "cboProcedencia"
        };
        ...
        private void LoadData()
        {
            ...
            else if (_mode == "Edit")
            {
                ...
                cboProcedencia.SelectedValue = _protocolDTO.i_Consultorio.ToString();
        ...
        private void LoadComboBox()
        {
            ...
            Utils.LoadDropDownList(cboProcedencia, "Value1", "Id", BLL.Utils.GetSystemParameterForCombo(ref objOperationResult, 361, null), DropDownListAction.Select);
