        ...
        private void btnDoctor_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                using (new LoadingClass.PleaseWait(this.Location, "Generando..."))
                {
                    ...
                    Liquidacion_Hospitalizacion.CreateLiquidacionGlobal(ruta + nombre + ".pdf", MedicalCenter, lista, datosP, doctor, hospitalizacion, hospitalizacionhabitacion, medicoTratante);
        ...
        private void btnPaciente_Click(object sender, EventArgs e)
        {
            ...
            else 
            {
                using (new LoadingClass.PleaseWait(this.Location, "Generando..."))
                {
                    ...
                    Liquidacion_Hospitalizacion.CreateLiquidacionGlobal(ruta + nombre + ".pdf", MedicalCenter, lista, datosP, paciente, hospitalizacion, hospitalizacionhabitacion, medicoTratante);
                    this.Enabled = true;
                }
                this.Close();
            }
