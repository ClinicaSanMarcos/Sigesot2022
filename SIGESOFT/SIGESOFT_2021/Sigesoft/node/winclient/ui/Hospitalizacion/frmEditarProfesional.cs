    ...
    public partial class frmEditarProfesional : Form
    {
        ...
        private void frmEditarProfesional_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (o.i_TipoComisionAfecta == 1)
                {
                    rbMedTratante.Checked = true;
                    rbMedSolicitante.Checked = false;
                }
                else if (o.i_TipoComisionAfecta == 2)
                {
                    rbMedTratante.Checked = false;
                ...
                if (o.v_ComentaryUpdate == null)
                {
                    txtObservaciones.Text = "- - -";
                }
                else
                {
                    txtObservaciones.Text = o.v_ComentaryUpdate;
                }
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                {
                    OmedicoDto.i_TipoComisionAfecta = 1;
                }
                else if (rbMedSolicitante.Checked == true)
                {
                    OmedicoDto.i_TipoComisionAfecta = 2;
                }
                else
                {
                ...
                OmedicoDto.v_ComentaryUpdate = txtObservaciones.Text;
