    ...
    public partial class frmHabitaciones : Form
    {
        ...
        private void frmHabitaciones_Load(object sender, EventArgs e)
        {
            ...
            else if (_mode == "EditASEGU" || _mode == "EditHOSPI")
            {
                ...
                {
                    dtpFFIN.Value = _hospitalizacionHabitaciónDto.d_EndDate.Value;
                }
        ...
        private void btnGuardarTicket_Click(object sender, EventArgs e)
        {
            ...
            if ((_mode == "EditASEGU") || _mode == "EditHOSPI")
            {
            ...
            {
                if (dtpFechaInicio.Value >= dtpFFIN.Value)
                {
                ...
                _hospitalizacionHabitaciónDto.i_HabitacionId = HabitacionId;
                _hospitalizacionHabitaciónDto.d_StartDate = dtpFechaInicio.Value;
                _hospitalizacionHabitaciónDto.d_EndDate = (DateTime?)(dtpFFIN.Checked == false ? (ValueType)null : dtpFFIN.Value);
