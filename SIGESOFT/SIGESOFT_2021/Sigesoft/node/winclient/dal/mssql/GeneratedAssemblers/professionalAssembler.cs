...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public static partial class professionalAssembler
    {
        ...
        public static professional ToEntity(this professionalDto dto)
        {
            ...
            entity.r_MonthlyPayment = dto.r_MonthlyPayment;
            entity.t_MonthlyHours = dto.t_MonthlyHours;
            entity.d_StartDateOfWork = dto.d_StartDateOfWork;
            entity.d_ContractFrom = dto.d_ContractFrom;
            entity.d_ContractUntil = dto.d_ContractUntil;
            entity.d_CessationDate = dto.d_CessationDate;
            entity.i_GrupoHorario = dto.i_GrupoHorario;
            entity.i_CodigoProfesion = dto.i_CodigoProfesion;
        ...
        public static professionalDto ToDTO(this professional entity)
        {
            ...
            dto.r_MonthlyPayment = entity.r_MonthlyPayment;
            dto.t_MonthlyHours = entity.t_MonthlyHours;
            dto.d_StartDateOfWork = entity.d_StartDateOfWork;
            dto.d_ContractFrom = entity.d_ContractFrom;
            dto.d_ContractUntil = entity.d_ContractUntil;
            dto.d_CessationDate = entity.d_CessationDate;
            dto.i_GrupoHorario = entity.i_GrupoHorario;
            dto.i_CodigoProfesion = entity.i_CodigoProfesion;
